...
public:
    ...
    friend circle operator*(circle &right, double n);
    friend circle operator+(circle &left, circle &right);
private:
    double aktina;
};
...
circle operator*(circle &right, double n){
    circle c;
    double aktina_new;
    aktina_new=n*(right.get_aktina());
    c.set_aktina(aktina_new);
    return c;
}

circle operator+(circle &left, circle &right){
    circle c;
    double aktina_new;
    aktina_new = left.get_aktina() + right.get_aktina();
    c.set_aktina(aktina_new);
